...
# == main ==
outdir='f6_cox_div_gene_beatAML_survival'
...
beatAML_data=np.transpose(beatAML_expression_df.loc[div_genes])

inner_product=np.inner(beatAML_data[selected_genes],cph.summary['coef'][selected_genes])
