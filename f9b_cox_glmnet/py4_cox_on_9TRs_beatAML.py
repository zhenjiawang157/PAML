...
beatAML_data=np.transpose(beatAML_expression_df.loc[selected_TRs].dropna()) # gene on the column
...
for penalizer in penalizers[:]:
    for l1_ratio in l1_ratios[:]:
        basename = 'TR9_Cox_penalizer{}_l1_ratios{}'.format(penalizer,l1_ratio)
