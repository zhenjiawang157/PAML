...
outdir='f4_Patient_KnockTF_DEG_cor_VS_patient_TFexpr_PAML'
os.makedirs(outdir,exist_ok=True)
project_dir="/nv/vol190/zanglab/zw5j/wwork2018/AML_fran/"
# project_dir="/Volumes/zanglab/zw5j/wwork2018/AML_fran/"
# deg_clustering_dir = '{}/manuscript_figs/f1_DEG_with_mutation_kmeans_patient/f3_kmeans_clustering'.format(project_dir)
