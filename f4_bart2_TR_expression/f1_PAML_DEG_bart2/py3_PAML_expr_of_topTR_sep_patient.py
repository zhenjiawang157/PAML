...
# ==== main section
outdir = 'f3_PAML_expr_of_topTR_sep_patient'
...
for group in ['div','up','down']:
    for cohort in ["PAML"]:
        ...
        #==== bart top tf
        top_tf_num = 10
        bart_results_file=glob.glob('f1_kmeans_DEG_bart2_results/PAML_pthre5_rk3_ck2_genes_*{}_bart_results.txt'.format(group))[0]
